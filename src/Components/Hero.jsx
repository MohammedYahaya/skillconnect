...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center text-center px-6 overflow-hidden">
      ...
      {/* Title */}
      <h2 className="hero-heading mt-28 hero-title syncopate-bold z-20 text-4xl md:text-7xl font-extrabold leading-tight">
        Find <span className="text-blue-600 drop-shadow-sm">Skilled</span> Experts
        <br />
        In Your Community
      </h2>
      ...
      {/* CTA */}
      <button className="relative hero-text opacity-0 translate-y-6 z-40 bg-teal-500 hover:bg-teal-600 font-jakarta transition px-8 py-3 text-white text-lg rounded-full shadow-xl flex items-center gap-2 group">
        Explore Services
        <svg
          fill="currentColor"
